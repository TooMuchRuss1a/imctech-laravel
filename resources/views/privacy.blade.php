    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200" style="text-indent: 1.6rem">
                    <div class="ml-3"><strong>1 Общие положения</strong></div>
                    ...
                    <div class="mt-2 ml-3"><strong>2 Основные понятия, используемые в Политике</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>3 Основные права и обязанности Оператора</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>4 Основные права и обязанности субъектов персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>5 Оператор может обрабатывать следующие персональные данные Пользователя</strong>
                    </div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>6 Принципы обработки персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>7 Цели обработки персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>8 Правовые основания обработки персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>9 Условия обработки персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>10 Порядок сбора, хранения, передачи и других видов обработки персональных
                            данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>11 Перечень действий, производимых Оператором с полученными персональными
                            данными</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>12 Трансграничная передача персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>13 Конфиденциальность персональных данных</strong></div>
                    <div style="padding-left: 0.8rem">
                    ...
                    <div class="mt-2 ml-3"><strong>14 Заключительные положения</strong></div>
                    <div style="padding-left: 0.8rem">
