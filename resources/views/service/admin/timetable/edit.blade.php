                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="date" type="text"
                                           ...
                                           name="date"
                                           value="{{ old('date') ? old('date') : $day->date->format('Y-m-d') }}"
                                           required autofocus autocomplete="off" placeholder="2022-01-01">
                                    @error('date')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                           ...
                                           value="{{ old('name') ? old('name') : $day->name }}" required
                                           autocomplete="off" placeholder="Презентация проектов">
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="place" type="text"
                                           ...
                                           value="{{ old('place') ? old('place') : $day->place }}" required
                                           autocomplete="off" placeholder="G464">
                                    @error('place')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                @forelse($day->timelines as $timeline)
                                    <div class="row-{{{$loop->index}}}">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="from-{{{$loop->index}}}" type="text"
                                                       class="form-control @error('from-'.$loop->index) is-invalid @enderror"
                                                       name="from-{{{$loop->index}}}"
                                                       value="{{ old('from-'.$loop->index) ? old('from-'.$loop->index) : $timeline->from->format('H:i') }}"
                                                       required autocomplete="off" placeholder="12:00">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <input id="to-{{{$loop->index}}}" type="text"
                                                       class="form-control @error('to-'.$loop->index) is-invalid @enderror"
                                                       name="to-{{{$loop->index}}}"
                                                       value="{{ old('to-'.$loop->index) ? old('to-'.$loop->index) : $timeline->to->format('H:i') }}"
                                                       required autocomplete="off" placeholder="13:00">
                                                @error('to-'.$loop->index)
                                                <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <textarea id="description-{{{$loop->index}}}" type="text"
                                                          class="form-control @error('description-'.$loop->index) is-invalid @enderror"
                                                          name="description-{{{$loop->index}}}" required
                                                          autocomplete="off"
                                                          placeholder="Что будет, спикеры и тд">{{ old('description-'.$loop->index) ? old('description-'.$loop->index) : $timeline->description }}</textarea>
