...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-11">
                <div class="card">
                    <div class="card-header">{{ __('Мероприятие') }}<a class="btn btn-primary p-1 position-absolute"
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="container p-2">
                            <div class="container"
                                ...
                                <div><img src="{{$event->conversation['photo']}}" class="rounded-5 p-1 d-inline"
                            ...
                            @forelse($event->activities as $activity)
                                <tr>
                                    ...
                                    <td><a class="link-primary"
                                           href="{{{$activity->user->vk->link}}}">{{$activity->user->vk->link}}</a></td>
                                    <td>
                                        <a class="btn btn-primary"
                                           href="{{route('admin.users.view', ['id' => $activity->user->id])}}"
