                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.getlost') }}">
                            ...
                            <div class="row mb-3">
                                <label for="text"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Выберите мероприятие') }}</label>

                                <div class="col-md-6">
                                    <select id="event_id" type="text"
                                            class="form-select @error('event_id') is-invalid @enderror" name="event_id"
                                            required>
