...
return [
    ...
    'dvfu_email' => 'Введите корпоративную почту ДВФУ',
    'unique_email' => 'Почта уже зарегистрирована',
    'recaptcha' => 'Капча не пройдена',
    'email_verified' => 'Пользователь не подтвердил почту',
    'register_actual' => 'Регистрация на мероприятие закрыта',
    'name_russian' => 'ФИО должны быть на русском языке',
    'valid_vk' => 'Недействительная ссылка на ВК',
    'valid_conversation_id' => 'Бот не имеет доступа к ссылке для приглашения в беседу ВК',
    'agroup' => 'Недействительная академическая группа',
];
